...
<body class="mobilemenu-active">
    ...
    <div id="main-wrapper" class="main-wrapper">
                            ...
                            <div class="news-feed-wrap">
                                ...
                                <div id="news-feed-slider" class="news-feed-slider initially-none">
                                    <div class="single-slide">
                                        <a href="post-format-default.php" class="link-wrap">Underwater Exercise Is Used Weak Of Muscles Thats Good</a>
                                    </div>
                                    <div class="single-slide">
                                        <a href="post-format-default.php" class="link-wrap">Tesla’s Cooking Up A New Way To Wire</a>
                                    </div>
                                    <div class="single-slide">
                                        <a href="post-format-default.php" class="link-wrap">50 Years After The Moon Landing: How Close</a>
                                    </div>
                                    <div class="single-slide">
                                        <a href="post-format-default.php" class="link-wrap">Millions Of Manuscripts Are Written</a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end animate slideIn" aria-labelledby="navbarDropdown1">
                                                        <div class="dropdown-menu-inner">
                                                            ...
                                                            <div class="item-wrap">
                                                                <a href="post-format-default.php" class="notification-item">
                                                                    <div class="post-box">
                                                            ...
                                                            <div class="notification-btn-wrap">
                                                                <a href="archive.php" class="w-100 axil-btn axil-btn-ghost btn-color-alter axil-btn-small">View All
                ...
                <div class="container">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-md-block d-none">
                            <a href="index.php" class="link-wrap desktop-logo img-height-100" aria-label="Site Logo"><img width="131" height="47" src="assets/media/logo-dark.svg" alt="logo"></a>
                        </div>
                        <div class="d-md-none d-block">
                            <a href="index.php" class="link-wrap mobile-logo img-height-100" aria-label="Site Logo"><img width="86" height="31" src="assets/media/mobile-logo.svg" alt="logo"></a>
                        </div>
                        <!-- Start Mainmenu Nav -->
                        <div id="mobilemenu-popup" class="mobile-menu-wrap">
                            <div class="mobile-logo-wrap d-lg-none d-block">
                                <div class="logo-holder">
                                    <a href="index.php" class="link-wrap single-logo light-mode img-height-100" aria-label="Site Logo"><img width="131" height="47" src="assets/media/logo-dark.svg" alt="logo"></a>
                                    <a href="index.php" class="link-wrap single-logo dark-mode img-height-100" aria-label="Site Logo"><img width="131" height="47" src="assets/media/logo-light.svg" alt="logo" aria-label="Site Logo"></a>
                                </div>
                            ...
                            <nav id="dropdown" class="template-main-menu">
                                <ul class="menu">
                                    <li class="menu-item menu-item-has-children">
                                        <a href="#">Home</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="index.php">Home Default</a></li>
                                            <li class="menu-item"><a href="home-modern.php">Home Modern</a></li>
                                            <li class="menu-item"><a href="home-standard.php">Home Standard</a></li>
                                            <li class="menu-item"><a href="home-news.php">Home News</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item">
                                    ...
                                    <li class="menu-item menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="menu-item menu-item-has-children second-lavel">
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="menu-item"><a href="archive-layout1.php">Archive Layout 1</a></li>
                                                    <li class="menu-item"><a href="archive-layout2.php">Archive Layout 2</a></li>
                                                    <li class="menu-item"><a href="archive-layout3.php">Archive Layout 3</a></li>
                                                    <li class="menu-item"><a href="archive-layout4.php">Archive Layout 4</a></li>
                                                    <li class="menu-item"><a href="archive-layout5.php">Archive Layout 5</a></li>
                                                    <li class="menu-item"><a href="archive-layout6.php">Archive Layout 6</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children second-lavel">
                                                <a href="#">Other Pages</a>
                                                <ul class="sub-menu">
                                                    <li class="menu-item"><a href="author.php">Author</a></li>
                                                    <li class="menu-item"><a href="404.php">404</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-has-children mega-menu-desktop d-lg-block d-none">
                                            ...
                                            <div class="mega-menu-bg">
                                                <div class="row">
                                                    <div class="col-lg-3 col-12">
                                                        <ul class="sub-menu">
                                                            <li class="menu-item"><a href="post-format-default.php">Single Default</a></li>
                                                            <li class="menu-item"><a href="post-format-full-width-banner.php">Single Full Width Banner</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-3 col-12">
                                                        <ul class="sub-menu">
                                                            <li class="menu-item"><a href="post-format-standard.php">Single Standard</a></li>
                                                            <li class="menu-item"><a href="post-format-without-sidebar.php">Single Without Sidebar</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-3 col-12">
                                                        <ul class="sub-menu">
                                                            <li class="menu-item"><a href="post-format-audio.php">Single Audio</a></li>
                                                            <li class="menu-item"><a href="post-format-slider.php">Single Slider</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-3 col-12">
                                                        <ul class="sub-menu">
                                                            <li class="menu-item"><a href="post-format-video.php">Single Video</a></li>
                                    ...
                                    <li class="menu-item menu-item-has-children mega-menu-mobile d-lg-none d-block">
                                        <a href="#">Single Blog</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="post-format-default.php">Single Default</a></li>
                                            <li class="menu-item"><a href="post-format-full-width-banner.php">Single Full Width Banner</a></li>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end animate slideIn" aria-labelledby="navbarDropdown2">
                                                <div class="dropdown-menu-inner">
                                                    ...
                                                    <div class="profile-content">
                                                        <ul>
                                                            <li><a href="author.php">Become a Member</a></li>
                                                            <li><a href="author.php">Apply for author verification</a></li>
                                                            <li><a href="author.php">Settings</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="mt-3">
        ...
        <!--=          Post Area Start          =-->
        <!--=====================================-->
        <section class="space-top-60 space-bottom-60 single-blog-wrap6 bg-color-light-1 transition-default">
            <div class="container">
                <div class="row sticky-coloum-wrap">
                    <div class="col-lg-8 sticky-coloum-item">
                        <div class="single-blog-content content-layout1 pe-lg-4">
                            <div class="banner-figure-holder mb-4">
                                <div class="position-relative">
                                    <div id="post-slider-4" class="post-slider-4 img-height-100 gutter-30">
                                        <div class="single-slide ">
                                            <div class="box-border-dark-1 radius-default transition-default">
                                                <div class="figure-holder radius-medium">
                                                    <img width="810" height="490" src="assets/media/blog/post90.webp" alt="Post">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="single-slide">
                                            <div class="box-border-dark-1 radius-default transition-default">
                                                <div class="figure-holder radius-medium">
                                                    <img width="810" height="490" src="assets/media/blog/post89.webp" alt="Post">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="single-slide">
                                            <div class="box-border-dark-1 radius-default transition-default">
                                                <div class="figure-holder radius-medium">
                                                    <img width="810" height="490" src="assets/media/blog/post78.webp" alt="Post">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <ul class="slider-navigation-layout1 color-light-1-fixed nav-size-regular position-layout1">
                                        <li id="post-prev-4" class="prev"><i class="regular-arrow-left"></i></li>
                                        <li id="post-next-4" class="next"><i class="regular-arrow-right"></i></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="entry-category style-2 color-dark-1">
                                <ul>
                                    <li>
                                        <a href="archive-layout1.php">TECH</a>
                                    </li>
                                </ul>
                            </div>
                            <h1 class="entry-title color-dark-1">The Science Behind Skin Care Products Has Come</h1>
                            <ul class="entry-meta color-dark-1">
                                ...
                                <li>
                                    <i class="regular-calendar-01"></i>Oct 18, 2023
                                </li>
                                <li>
                            ...
                            <p>On August 15th, an alarming email popped up in the inbox of Diana Pearl, a New York-based news editor. Someone in Moscow had logged into her verified Twitter account, it said. Pearl was familiar with the email content’s theme as it resembled previous automated correspondence from Twitter — featuring a minimal white background, black text, and blue links.</p>
                            <p>I’ve created a Team Health Check template based on the exercise I run with my teams. It’s super simple to use and above all, it’s light-hearted and enjoyable.</p>
                            <p>It’s a guided experience, so you don’t need to prepare anything in advance other than setting aside 40 minutes with your team (for teams over six, I’d suggest an hour). By repeating the exercise over consecutive months your team can track the feels and compare results across exercises, Unlike a typical retrospective, the</p>
                            <h4 class="h4-large">For Each Category, Your Team Needs To Cast Two Votes:</h4>
                            <ul class="list-style-1">
                                <li>How are you feeling right now? Confident or happy, indifferent or satisfied, concerned or
                                    downbeat</li>
                                <li>I find this prevents us from rabbit-holing? on topics thatConfident or happy, indifferent or
                                    satisfied, concerned or downbeat</li>
                            </ul>
                            <p>Categories are time-bound. I find this prevents us from rabbit-holing on topics that could consume the entire session, instead, these are tabled for future conversations. With our challenges laid out on the table, the exercise encourages an outcomes-focused mindset to help us divine actions that contribute to removing hurdles, improving perceptions, and resolving conflicts.</p>
                            <h4 class="h4-large">Stumbling, Twisting Or Slipping Are Responsible For Almost A New Joinee Post</h4>
                            <p>Difficulties from the area of ​​tour planning (see Table 1) were represented several times among the 10 most common difficulties: poorer road conditions, tour cancellation, increased time requirement or a tour that was more difficult than expected. Orientation difficulties were also frequently</p>
                            <figure class="figure-holder mb-3 radius-default img-height-100">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="box-border-dark-1 radius-default transition-default">
                                            <div class="figure-holder img-height-100 radius-medium">
                                                <img width="630" height="500" src="assets/media/blog/post109.webp" alt="figure">
                                            </div>
                                        </div>
                                        <div class="figure-caption text-center">A caption for the above image.</div>
                                    </div>
                                    <div class="col-6">
                                        <div class="box-border-dark-1 radius-default transition-default">
                                            <div class="figure-holder img-height-100 radius-medium">
                                                <img width="630" height="500" src="assets/media/blog/post110.webp" alt="figure">
                                            </div>
                                        </div>
                                        <div class="figure-caption text-center">A caption for the above image.</div>
                                    </div>
                            ...
                            <p>Difficulties from the area of ​​tour planning (see Table 1) were represented several times among
                                the 10 most common difficulties: poorer road conditions, tour cancellation, increased time
                                requirement or a tour that was more difficult than expected. Orientation <span>difficulties were
                                    also frequently</span></p>
                            <blockquote>
                                <p>I find this prevents us from rabbit-holing on topics that could consume the entire session. With the exercise encourages an outcomes-focused mindset to help us divine actions that contribute to removing hurdles.</p>
                                <cite>Amy Amber</cite>
                            </blockquote>
                            <p>Categories are time-bound. I find this prevents us from rabbit-holing on topics that could
                                consume the entire session, instead, these are tabled for future conversations. With our
                                challenges laid out on the table, the exercise encourages an outcomes-focused mindset to help us
                                divine actions </p>
                            <h4 class="h4-large">Designed A Fun And Dynamic Hackout Event Poster For All The Colleges.</h4>
                            <p>Difficulties from the area of ​​tour planning (see Table 1) were represented several times among
                                the 10 most common difficulties: poorer more difficult than expected. Orientation difficulties
                                were also frequently</p>
                            <h4 class="h4-large">New Joinee Post Template</h4>
                            <ul class="list-style-1">
                                <li>Leave extra space between you and other cars</li>
                                <li>Contrary to popular belief, Lorem Ipsum is not simply random text</li>
                                <li>There are many variations of passages of Lorem Ipsum available</li>
                                <li>you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything</li>
                                <li>Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum</li>
                            </ul>
                            <h4 class="h4-large">Designed A Fun And Dynamic Hackout Event Poster For All The Colleges.</h4>
                            <p>Difficulties from the area of ​​tour planning (see Table 1) were represented several times among
                                the 10 most common difficulties: poorer more difficult than expected. Orientation difficulties
                                were also frequently. Meta submitted a request to dismiss the Federal Trade Commission's. Pearl
                                was familiar with the email content’s theme as it resembled previous automated.</p>
                            <p>On August 15th, an alarming email popped up in the inbox of Diana Pearl, a York-based news
                                editor. Someone in Moscow had logged into her verified Twitter account, it said. Pearl was
                                familiar with the email content’s theme as it resembled previous automated correspondence from
                                Twitter — featuring a minimal white background, black text, and blue links.</p>
                            <p>While the law might seem obvious, designers often engage in creative work where they try to
                                reinvent the wheel for the sake of novelty. Of course, we as designers are tasked with providing
                                clients and users with new and inventive solutions, but it is important to understand that there
                                are inherent user expectations and mental models to which we should cater. </p>
                            ...
                            <div class="post-navigation">
                                <div class="post-box prev-post">
                                    <div class="figure-holder">
                                        <a href="post-format-default.php" class="link-wrap img-height-100"><img width="540" height="540" src="assets/media/blog/post60.webp" alt="Post"></a>
                                    </div>
                                    <div class="content-holder">
                                        ...
                                        <h3 class="entry-title h3-small color-dark-1 underline-animation"><a href="post-format-default.php" class="link-wrap">Underwater Exercise Is Used Strengthen Weak Muscles</a></h3>
                                    </div>
                                </div>
                                <div class="post-box next-post">
                                    <div class="figure-holder">
                                        <a href="post-format-default.php" class="link-wrap img-height-100"><img width="540" height="540" src="assets/media/blog/post61.webp" alt="Post"></a>
                                    </div>
                                    <div class="content-holder">
                                        <a href="post-format-default.php" class="text-box next-text">Next Post<div class="icon-holder"><i class="regular-arrow-right"></i></div></a>
                                        <h3 class="entry-title h3-small color-dark-1 underline-animation"><a href="post-format-default.php" class="link-wrap">The Science Skin-car A Long Way But There’s Still</a></h3>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <li>
                                        ...
                                        <ul class="children">
                                            <li>
                                                <div class="each-comment">
                                                    <div class="comment-figure img-height-100">
                                                        <img width="500" height="500" src="assets/media/blog/post18.webp" alt="Comment">
                                                    </div>
                                                    <div class="comment-content">
                        ...
                        <div class="sidebar-global sidebar-layout4">
                                ...
                                <div class="widget-post post-layout1">
                                    <div class="post-box">
                                        <div class="figure-holder radius-default">
                                            <a href="post-format-default.php" class="link-wrap figure-overlay img-height-100"><img width="700" height="470" src="assets/media/blog/post23.webp" alt="Post"></a>
                                        </div>
                                        <div class="content-holder">
                                            <h3 class="entry-title color-light-1-fixed h3-small underline-animation"><a href="post-format-default.php" class="link-wrap">Top 5 Street Tacos In Usa Top 5 Street Tacos
                                                    In Usa</a></h3>
                                    ...
                                    <div class="post-box">
                                        <div class="figure-holder radius-default">
                                            <a href="post-format-default.php" class="link-wrap figure-overlay img-height-100"><img width="140" height="140" src="assets/media/blog/post14.webp" alt="Post"></a>
                                        </div>
                                        <div class="content-holder">
                                            <h3 class="entry-title color-dark-1 underline-animation h3-extra-small"><a href="post-format-default.php" class="link-wrap">Smarter Food 101 Tips For Your Health</a></h3>
                                            <ul class="entry-meta color-dark-1">
                                                <li>
                                                    <i class="regular-clock-circle"></i>2 min read
                                                </li>
                                    ...
                                    <div class="post-box">
                                        <div class="figure-holder radius-default">
                                            <a href="post-format-default.php" class="link-wrap figure-overlay img-height-100"><img width="140" height="140" src="assets/media/blog/post15.webp" alt="Post"></a>
                                        </div>
                                        <div class="content-holder">
                                            <h3 class="entry-title color-dark-1 underline-animation h3-extra-small"><a href="post-format-default.php" class="link-wrap">Virtual Reality (VR), The Use Computer
                                                    Modeling</a></h3>
                                            <ul class="entry-meta color-dark-1">
                                                <li>
                                                    <i class="regular-clock-circle"></i>8 min read
                                    ...
                                    <div class="post-box">
                                        <div class="figure-holder radius-default">
                                            <a href="post-format-default.php" class="link-wrap figure-overlay img-height-100"><img width="140" height="140" src="assets/media/blog/post16.webp" alt="Post"></a>
                                        </div>
                                        <div class="content-holder">
                                            <h3 class="entry-title color-dark-1 underline-animation h3-extra-small"><a href="post-format-default.php" class="link-wrap">Reality Hosting, The Use Computer Modeling</a>
                                            </h3>
                                            <ul class="entry-meta color-dark-1">
                                                <li>
                            ...
                            <div class="sidebar-widget">
                                <div class="widget-banner banner-layout2">
                                    <div class="figure-holder radius-default box-border-dark-1">
                                        <a href="#" class="link-wrap img-height-100"><img width="700" height="772" src="assets/media/banner/banner3.webp" alt="Banner"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-widget">
                                ...
                                <div class="widget-tagcloud tagcloud-layout4">
                                    <a href="archive-layout1.php" class="tag-cloud-link box-shadow-small shadow-style-2 box-border-dark-1">
                                        <span class="icon-holder">
                    ...
                    <div id="post-slider-3" class="post-slider-3 gutter-30 outer-top-5 initially-none">
                        <div class="single-slide">
                            <div class="post-box-layout6 box-border-dark-1 radius-default padding-20 bg-color-scandal box-shadow-large shadow-style-2 transition-default">
                                <div class="figure-holder radius-default">
                                    <a href="post-format-default.php" class="link-wrap img-height-100"><img width="660" height="470" src="assets/media/blog/post7.webp" alt="Post"></a>
                                </div>
                                <div class="content-holder">
                                    <div class="entry-category style-2 color-dark-1-fixed">
                                        <ul>
                                            <li>
                                                <a href="archive-layout1.php">FOOD</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <h3 class="entry-title color-dark-1-fixed underline-animation"><a href="post-format-default.php" class="link-wrap">Underwater Exercise Is Used Strengthen Muscles</a></h3>
                        ...
                        <div class="single-slide">
                            <div class="post-box-layout6 box-border-dark-1 radius-default padding-20 bg-color-mimosa box-shadow-large shadow-style-2 transition-default">
                                <div class="figure-holder radius-default">
                                    <a href="post-format-default.php" class="link-wrap img-height-100"><img width="660" height="470" src="assets/media/blog/post8.webp" alt="Post"></a>
                                </div>
                                <div class="content-holder">
                                    <div class="entry-category style-2 color-dark-1-fixed">
                                        <ul>
                                            <li>
                                                <a href="archive-layout1.php">SPORTS</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <h3 class="entry-title color-dark-1-fixed underline-animation"><a href="post-format-default.php" class="link-wrap">Beauty Of Deep Space. Billions Of In The Universe</a></h3>
                                    <ul class="entry-meta color-dark-1-fixed">
                                        <li class="post-author">
                                            <a href="author.php">
                        ...
                        <div class="single-slide">
                            <div class="post-box-layout6 box-border-dark-1 radius-default padding-20 bg-color-selago box-shadow-large shadow-style-2 transition-default">
                                <div class="figure-holder radius-default">
                                    <a href="post-format-default.php" class="link-wrap img-height-100"><img width="660" height="470" src="assets/media/blog/post9.webp" alt="Post"></a>
                                </div>
                                <div class="content-holder">
                                    <div class="entry-category style-2 color-dark-1-fixed">
                                        <ul>
                                    ...
                                    <h3 class="entry-title color-dark-1-fixed underline-animation"><a href="post-format-default.php" class="link-wrap">Air Pods Pro With Wireless Used Strengthen Weak</a></h3>
                                    <ul class="entry-meta color-dark-1-fixed">
                                        <li class="post-author">
                                            <a href="author.php">
                                                <img src="assets/media/blog/profile1.webp" alt="Author">
                                                Esther Howard
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div class="single-slide">
                            <div class="post-box-layout6 box-border-dark-1 radius-default padding-20 bg-color-old-lace box-shadow-large shadow-style-2 transition-default">
                                <div class="figure-holder radius-default">
                                    <a href="post-format-default.php" class="link-wrap img-height-100"><img width="660" height="470" src="assets/media/blog/post11.webp" alt="Post"></a>
                                </div>
                                <div class="content-holder">
                                    <div class="entry-category style-2 color-dark-1-fixed">
                                        <ul>
                                            <li>
                                                <a href="archive-layout1.php">HISTORY</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <h3 class="entry-title color-dark-1-fixed underline-animation"><a href="post-format-default.php" class="link-wrap">Millions Of Book Are Written By Jhon Abraham</a></h3>
                                    <ul class="entry-meta color-dark-1-fixed">
                                        <li class="post-author">
                                            <a href="author.php">
                                                <img src="assets/media/blog/profile2.webp" alt="Author">
                        ...
                        <div class="single-slide">
                            <div class="post-box-layout6 box-border-dark-1 radius-default padding-20 bg-color-mimosa box-shadow-large shadow-style-2 transition-default">
                                <div class="figure-holder radius-default">
                                    <a href="post-format-default.php" class="link-wrap img-height-100"><img width="660" height="470" src="assets/media/blog/post12.webp" alt="Post"></a>
                                </div>
                                <div class="content-holder">
                                    <div class="entry-category style-2 color-dark-1-fixed">
                                        <ul>
                                    ...
                                    <h3 class="entry-title color-dark-1-fixed underline-animation"><a href="post-format-default.php" class="link-wrap">Air Pods Pro With Wireless Charging Case That Make</a></h3>
                                    <ul class="entry-meta color-dark-1-fixed">
                                        <li class="post-author">
                                            <a href="author.php">
            ...
            <div class="container">
                <div class="newsletter-box-layout1 box-border-dark-1 radius-default bg-color-perano">
                    ...
                    <ul class="elements-wrap img-height-100">
                        <li><img width="57" height="53" src="assets/media/elements/element1.webp" alt="Element"></li>
                        <li><img width="120" height="186" src="assets/media/elements/element2.webp" alt="Element"></li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-3 col-6">
                                    <div class="instagram-box-layout1 box-border-light-1-fixed padding-20 pxy-xs-10 radius-default bg-color-scandal">
                                        <div class="figure-holder radius-default">
                                            <a target="_blank" href="https://www.instagram.com/themeforest/?hl=en" class="link-wrap img-height-100"><img width="300" height="300" src="assets/media/blog/post42.webp" alt="Post"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="instagram-box-layout1 box-border-light-1-fixed padding-20 pxy-xs-10 radius-default bg-color-mimosa">
                                        <div class="figure-holder radius-default">
                                            <a target="_blank" href="https://www.instagram.com/themeforest/?hl=en" class="link-wrap img-height-100"><img width="300" height="300" src="assets/media/blog/post43.webp" alt="Post"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="instagram-box-layout1 box-border-light-1-fixed padding-20 pxy-xs-10 radius-default bg-color-selago">
                                        <div class="figure-holder radius-default">
                                            <a target="_blank" href="https://www.instagram.com/themeforest/?hl=en" class="link-wrap img-height-100"><img width="300" height="300" src="assets/media/blog/post44.webp" alt="Post"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="instagram-box-layout1 box-border-light-1-fixed padding-20 pxy-xs-10 radius-default bg-color-old-lace">
                                        <div class="figure-holder radius-default">
                                            <a target="_blank" href="https://www.instagram.com/themeforest/?hl=en" class="link-wrap img-height-100"><img width="300" height="300" src="assets/media/blog/post45.webp" alt="Post"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-4 col-12">
                            <div class="footer-widget">
                                <div class="footer-about pe-lg-5">
                                    <div class="logo-holder">
                                        <a href="index.php" class="link-wrap img-height-100" aria-label="Site Logo"><img width="131" height="47" src="assets/media/logo-light.svg" alt="logo"></a>
                                    </div>
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-menu">
                                    <ul>
                                        ...
                                        <li><a href="archive-layout5.php">Culture Foram</a></li>
                                        <li><a href="archive.php">Culture Foram</a></li>
                                        <li><a href="archive.php">United Kingdom</a></li>
                                        <li><a href="archive.php">Media</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6 col-12">
                            <div class="footer-widget">
                                ...
                                <div class="footer-menu">
                                    <ul>
                                        <li><a href="archive-layout1.php">Technology</a></li>
                                        <li><a href="archive-layout2.php">Politics</a></li>
                                        <li><a href="archive-layout3.php">Middle East</a></li>
                                        <li><a href="archive-layout4.php">Culture Foram</a></li>
                                        <li><a href="archive-layout5.php">United Kingdom</a></li>
                                        <li><a href="archive-layout6.php">Features</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6 col-12">
                            <div class="footer-widget">
                                ...
                                <div class="footer-menu">
                                    <ul>
                                        <li><a href="archive-layout1.php">Business Leaders</a></li>
                                        <li><a href="archive-layout2.php">Markets</a></li>
                                        <li><a href="archive-layout3.php">Australia</a></li>
                                        <li><a href="archive-layout4.php">Celebrity News</a></li>
                                        <li><a href="archive-layout5.php">Culture Foram</a></li>
                                        <li><a href="archive-layout6.php">TV News</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-menu">
                                    <ul>
                                        ...
                                        <li><a href="archive-layout1.php">Music News</a></li>
                                        <li><a href="archive-layout2.php">Style News</a></li>
                                        <li><a href="archive-layout3.php">Entertainment</a></li>
                                        <li><a href="archive-layout4.php">Executive</a></li>
