...
<body class="mobilemenu-active">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <!--=          Post Area Start          =-->
        <!--=====================================-->
        <section class="single-blog-wrap2 space-bottom-60 bg-color-light-1 transition-default">
            <div class="single-blog-content content-layout2">
                <div class="mask-content">
                    ...
                    <h1 class="entry-title color-light-1-fixed">The Science Behind Skin Care Products Has Come Designed A Fun Dynamic.</h1>
                ...
                <div class="banner-figure-holder img-height-100">
                    <img width="2500" height="800" src="assets/media/blog/post79.webp" alt="Post">
                </div>
            </div>
            <div class="container">
